...
Route::get('/', function () {
    ...
    $candlesResponse = $bingx->candles('FTM-USDT',100, '30m');

    $utbotStrategy = new \App\Services\Strategy\UTBotAlertStrategy($candlesResponse->data(), 1, 10);

    dd($utbotStrategy->collection());
